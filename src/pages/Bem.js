  ...
  return (
    <>
      ...
      <section>
        ...
        <img src={imgcon1} className="bem_img" alt="" />

        <div className="bem_text">재사용 가능한 기능적으로 독립적인 페이지 컴포넌트</div>
      </section>
      ...
      <section>
        ...
        <img src={imgcon2} className="bem_img" alt="" />
      ...
      <section>
        ...
        <img src={imgcon3} className="bem_img" alt="" />

        <div className="bem_text">
          <b>블럭이나 엘리먼트의 속성</b>을 맡습니다. 기존과 비슷하지만 동작이나 생긴 게 조금 다른 블럭이나 엘리먼트를 만들 때 씁니다.
        </div>
      </section>
      ...
      <section>
        ...
        <img src={imgcon4} className="bem_img img_top" alt="" />
        <img src={lnbsample} className="bem_img" alt="" />
