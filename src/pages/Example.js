  ...
  return (
    <div>
      <section>
        ...
        <img src={list_icon} className="bem_img" alt="" />
      ...
      <section>
        ...
        <br />
        <br />
        <img src={html_class} className="bem_img" alt="" />
      ...
      <section>
        ...
        <br />
        <br />
        <img src={iconcss} className="bem_img" alt="" />
      ...
      <section>
        ...
        <br />
        <br />
        <img src={cssnew} className="bem_img" alt="" />
      ...
      <section>
        ...
        <br />
        <br />
        <img src={changeclass} className="bem_img" alt="" />
      ...
      <section>
        ...
        <br />
        <br />
        <img src={icon_change} className="bem_img" alt="" />
